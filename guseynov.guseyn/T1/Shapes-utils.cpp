...
double guseynov::getSumArea(const CompositeShape & compositeShape)
{
  return compositeShape.getArea();
}
void guseynov::scaleShapes(CompositeShape & compositeShape, point_t coordinate, double factor)
{
  if (factor <= 0)
  {
...
void guseynov::printData(std::ostream & out, const CompositeShape & compositeShape)
{
...
void guseynov::destroyShapes(CompositeShape & compositeShape)
{
