...
kiselev::Complexquad::Complexquad(point_t p1, point_t p2, point_t p3, point_t p4) : p1_(p1), p2_(p2), p3_(p3), p4_(p4)
{
}
...
double kiselev::Complexquad::getArea() const
{
  ...
  double area1 = std::sqrt(semiPerimeter1 * (semiPerimeter1 - lenghtP1p4) * (semiPerimeter1 - lenghtP1centre)
      * (semiPerimeter1 - lenghtP4centre));
  ...
  double area2 = std::sqrt(semiPerimeter2 * (semiPerimeter2 - lenghtP2p3) * (semiPerimeter2 - lenghtP2centre)
      * (semiPerimeter2 - lenghtP3centre));
  return area1 + area2;
}
