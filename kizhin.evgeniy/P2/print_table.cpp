...
template <typename T>
void kizhin::printCell(std::ostream& os, const T& data, size_t width,
                       size_t precision)
{
...
template void kizhin::printRow<double>(std::ostream&, double, const double&,
                                       double);
template void kizhin::printRow<char const*>(std::ostream&, double,
