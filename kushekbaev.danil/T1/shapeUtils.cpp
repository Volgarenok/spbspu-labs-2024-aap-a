...
bool kushekbaev::isTriangle(point_t first, point_t second, point_t third)
{
...
bool kushekbaev::isPointInsideTriangle(point_t first, point_t second, point_t third, point_t last)
{
...
void kushekbaev::movePoints(point_t** points, size_t size, double dx, double dy)
{
...
void kushekbaev::scalePoints(point_t** points, size_t size, double scaleCoeff, point_t mid)
{
  for (size_t i = 0; i < size; i++)
  {
...
double kushekbaev::getLineLength(point_t first, point_t second)
{
...
double kushekbaev::getAreaOfTriangle(point_t first, point_t second, point_t third)
{
  double side1 = getLineLength(first, second);
  double side2 = getLineLength(second, third);
  double side3 = getLineLength(first, third);
