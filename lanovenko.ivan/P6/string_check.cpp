...
const char* lanovenko::is_symbol(const char* str, char c)
{
  if (!str)
  {
    return str;
...
const char* lanovenko::is_sign(const char* str)
{
  if (!str)
  {
    return str;
...
const char* lanovenko::is_digit(const char* str)
{
  if (!str)
  {
    return str;
...
const char* lanovenko::is_unsigned_int(const char* str)
{
  if (!str)
  {
    return str;
...
const char* lanovenko::is_E_digit(const char* str)
{
  if (!str)
  {
    return str;
...
const char* lanovenko::is_mantissa(const char* str)
{
  if (!str)
  {
    return str;
