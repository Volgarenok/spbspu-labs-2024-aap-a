...
namespace petrov
{
  ...
  rectangle_t getFrameRectByOtherShapes(Shape ** ptr_shapes, size_t number_of_shapes);
  rectangle_t getFrameRectByOtherShapes(const Shape ** ptr_shapes, size_t number_of_shapes);
}
#endif
