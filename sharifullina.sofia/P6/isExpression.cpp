...
const char * sharifullina::isSymbol(const char * str, const char c)
{
  if (!str)
  {
    return str;
...
const char * sharifullina::hasExpression(const char * str)
{
  if (!str)
  {
    return str;
...
const char * sharifullina::hasNumber(const char * str)
{
  if (!str)
  {
    return str;
...
const char * sharifullina::hasLetter(const char * str)
{
  if (!str)
  {
    return str;
